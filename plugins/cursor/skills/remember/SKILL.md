---
name: remember
description: Store something in Reintersect so every agent and teammate sees it later. Use when the user explicitly asks to remember, note, or save a fact, decision or preference.
...
can undo it with `/reintersect:forget`.
